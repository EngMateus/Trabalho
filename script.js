...
function calculararea(){
    ...
    resultadoarea.innerHTML = "Area do terreno é de: "+ comprimento * largura + "m²"
}
...
function calcularferraduras(){
    ...
    resultadoferraduras.innerHTML = "Quantidade de ferraduras necessarias serão:"+ qtdferraduras
}
...
function calcularlitros(){
    ...
    h4resultadolitro.innerHTML = "O valor colocado foi de R$ "+valorcolocado+" e rendeu "+calcular.toFixed(1)+"L"
}
